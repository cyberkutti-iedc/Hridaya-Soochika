interface ResultCardProps {
  ...
  export default function ResultCard({ compatibility, details }: ResultCardProps) {
    // Function to determine background color based on compatibility score
    ...
    // Function to get emoji based on compatibility score
    ...
    // Function to get description based on compatibility score
    ...
    return (
      <div className="text-center">
        <div className="mx-auto w-40 h-40 mb-4 rounded-full flex items-center justify-center text-4xl border-8 border-pink-200" style={{ background: `conic-gradient(${getCompatibilityColor(compatibility)} ${compatibility}%, #f3f4f6 0)` }}>
